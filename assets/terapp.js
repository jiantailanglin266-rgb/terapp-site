...
(function(){
  ...
  (function(){
    ...
    function spawn(){
      ...
      wrap.style.setProperty('--fo', rnd(.22,.42).toFixed(2));
      ...
      p.setAttribute('fill','none'); p.setAttribute('stroke', Math.random()<.25 ? '#E99AAD' : '#C9A86A'); p.setAttribute('stroke-width','1');
      var spine = document.createElementNS(svgNS,'path');
      spine.setAttribute('d','M12 3v42'); spine.setAttribute('stroke','#C9A86A'); spine.setAttribute('stroke-width','.7'); spine.setAttribute('opacity','.7');
